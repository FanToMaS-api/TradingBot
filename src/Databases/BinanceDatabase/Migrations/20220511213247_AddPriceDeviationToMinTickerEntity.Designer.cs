...
namespace BinanceDatabase.Migrations
{
    ...
    [Migration("20220511213247_AddPriceDeviationToMinTickerEntity")]
    partial class AddPriceDeviationToMinTickerEntity
    {
            ...
            modelBuilder.Entity("BinanceDatabase.Entities.MiniTickerEntity", b =>
                {
                    ...
                    b.Property<int>("AggregateDataInterval")
                        .HasColumnType("integer")
                        .HasColumnName("aggregate_data_interval");
                    ...
                    b.HasIndex("AggregateDataInterval")
                        .HasDatabaseName("IX_mini_tickers_aggregate_data_interval");
                    ...
                    b.HasIndex("PriceDeviationPercent")
                        .HasDatabaseName("IX_mini_tickers_price_deviation");

...
{
    /// <summary>
    ///    Строитель для групп фильтров общего назначения, которые будут вызываться в последнюю очередь
    /// </summary>
    public class CommonLatestFilterGroupBuilder : FilterManagerBuilder
    {
        #region Fields
        ...
        /// <inheritdoc cref="CommonLatestFilterGroupBuilder"/>
        public CommonLatestFilterGroupBuilder()
            : base()
        { }
        ...
        /// </remarks>
        public CommonLatestFilterGroupBuilder SetTargetTradeObjectName(string name)
        {
        ...
        public CommonLatestFilterGroupBuilder SetFilterGroupName(string filterGroupName)
        {

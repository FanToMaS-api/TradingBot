...
{
    /// <summary>
    ///    Строитель для специальных групп фильтров
    /// </summary>
    public class SpecialFilterGroupBuilder : FilterManagerBuilder
    {
        #region Fields
        ...
        /// <inheritdoc cref="SpecialFilterGroupBuilder"/>
        public SpecialFilterGroupBuilder()
            : base()
        { }
        ...
        /// </remarks>
        public SpecialFilterGroupBuilder SetTargetTradeObjectName(string name)
        {
        ...
        public SpecialFilterGroupBuilder SetFilterGroupName(string filterGroupName)
        {
